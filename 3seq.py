...
numbers_sequence_1 = input("Введите чмсла, для разделения используйте ',', ';' либо '/': ").replace(';', ',').replace('/', ',').split(',')
numbers_list_1 = [int(elem) for elem in numbers_sequence_1]

numbers_sequence_2 = input("Введите чмсла, для разделения используйте ',', ';' либо '/': ").replace(';', ',').replace('/', ',').split(',')
